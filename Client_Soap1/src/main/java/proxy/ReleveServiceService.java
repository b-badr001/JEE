 ...
 * 
 */
@WebServiceClient(name = "ReleveServiceService", targetNamespace = "http://enset.ma/", wsdlLocation = "http://localhost:8000/ReleveWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVESERVICESERVICE_QNAME = new QName("http://enset.ma/", "ReleveServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8000/ReleveWS?wsdl");
    ...
    public ReleveWS getReleveWSPort() {
        return super.getPort(new QName("http://enset.ma/", "ReleveWSPort"), ReleveWS.class);
    }
    ...
    public ReleveWS getReleveWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://enset.ma/", "ReleveWSPort"), ReleveWS.class, features);
    }
